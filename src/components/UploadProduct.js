  ...
  uploadFile = (file, signedRequest, url) => {
    ...
    axios
      ...
      .then(response => {
        ...
        console.log(url, "url")
        axios.put('/api/updateproductimage', { url }).then(res => {
            console.log(res, "response from put on upload product");
    ...
    return (
      <div className='dropzone'>
                ...
                <section>
                    ...
                    {isUploading ? (<div style={{fontSize: 18}}>
                      Loading...
                      
                    </div>): (null)
                    // <button onClick={url => this.props.updateUrl(url)} className="normal-btn">Accept Image</button> 
                      }
                </div>
                </section>
            )}
